//
//  SettleCardScannerViewController.swift
//  settlepay-ios-sdk
//
...
protocol SettleCardScannerViewControllerDelegate: class {
    
    func didFindCardNumber(cardNumber: String)
    
}

class SettleCardScannerViewController: SettleBaseViewController {
    
    //MARK: - Defaults
    
    private enum Defaults {
        static let imageDetectionQueueName: String = "SettleCardScannerViewController.image.handling.queue"
    }
    ...
    weak var delegate: SettleCardScannerViewControllerDelegate?
...
extension SettleCardScannerViewController: StoryboardInstantiable {
...
extension SettleCardScannerViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
